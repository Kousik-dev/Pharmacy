...
const CartPage = () => {
  ...
  <div className="quantity-container" style={{ display: 'flex', alignItems: 'center' }}>
    <label htmlFor={`quantity-${p._id}`} className="quantity-label" style={{ marginRight: '10px', marginBottom: '0' }}>Quantity:</label>
    <input
  type="number"
  min="1"
  value={p.quantity}
  ...
  id={`quantity-${p._id}`}
  className="btn btn-success" // Retain the btn class for basic styling
  style={{ padding: '4px 8px', fontSize: '12px', width: '60px' }} // Set a custom width
/>
